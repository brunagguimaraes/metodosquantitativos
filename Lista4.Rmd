...
#distribuição nula via bootstrap
distribuicao_nula <- especificacao %>%
  generate(reps = 1000, type = "bootstrap")

# Calcular a estatística desejada, por exemplo, a diferença de médias
...
pontos_int <- dados_lista_4 %>%
  mutate(
    # Aqui assumimos um erro padrão arbitrário para exemplo, ajuste conforme necessário
